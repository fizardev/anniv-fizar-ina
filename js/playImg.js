...
function preshowImage(){
	document.getElementById("imgTxt").style.opacity = 0;
	myImage.setAttribute("src", imageArray[imageIndex]);
	myImage.style.width = "80%"; // Misalnya, atur lebar gambar menjadi 50% dari ukuran aslinya
	myImage.style.height = "auto"; // Biarkan tingginya menyesuaikan agar proporsi tetap
	myTxt.innerHTML = txtArray[imageIndex];
	imageIndex++;
	if(imageIndex >= len){
		imageIndex = 0;
